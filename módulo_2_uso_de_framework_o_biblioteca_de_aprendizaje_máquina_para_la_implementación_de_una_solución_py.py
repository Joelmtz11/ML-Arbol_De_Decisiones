...
"""Observando estas métricas y realizando análisis más detallados, podrás evaluar el sesgo de tu modelo de árbol de decisión y determinar si está sesgado en una dirección particular o si es adecuado para tu problema. Si notas un sesgo significativo, puedes ajustar el modelo, los hiperparámetros o los datos para abordar ese sesgo.
